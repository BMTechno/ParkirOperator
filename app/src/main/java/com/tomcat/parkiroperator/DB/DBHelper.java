...
public class DBHelper {
    ...
    public int getParkir(){
        List<NameValuePair> params=new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("action", "getParkir"));
        params.add(new BasicNameValuePair("id", id));
        params.add(new BasicNameValuePair("password", password));
        return send(params);
    }
    public int setAvailable(int parkirId, int available){
        List<NameValuePair> params=new ArrayList<NameValuePair>();
        params.add(new BasicNameValuePair("action", "setAvailable"));
        params.add(new BasicNameValuePair("id", id));
